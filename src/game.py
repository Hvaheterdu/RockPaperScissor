...
# Images used
ROCK_IMG = pygame.image.load(os.path.join(PARENT_FOLDER, 'img/rock.jpg'))
PAPER_IMG = pygame.image.load(os.path.join(PARENT_FOLDER, 'img/paper.png'))
SCISSOR_IMG = pygame.image.load(
    os.path.join(PARENT_FOLDER, 'img/scissor.jpg'))
